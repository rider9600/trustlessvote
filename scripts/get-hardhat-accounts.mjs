...
// Default Hardhat accounts (these are public test accounts, never use in production!)
...
console.log('HARDHAT ACCOUNTS (20 PRE-FUNDED TEST ACCOUNTS)');
console.log('='.repeat(80));
console.log('');
console.log('⚠️  WARNING: These are PUBLIC test keys. NEVER use in production!');
console.log('');

HARDHAT_ACCOUNTS.forEach((account, index) => {
...
console.log('='.repeat(80));
console.log('JSON Format (for database seeding):');
console.log('='.repeat(80));
console.log(JSON.stringify(HARDHAT_ACCOUNTS, null, 2));
