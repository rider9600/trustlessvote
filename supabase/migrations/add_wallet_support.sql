...
-- Create hardhat_wallet_pool table for 20 pre-funded accounts
CREATE TABLE IF NOT EXISTS public.hardhat_wallet_pool (
  ...
  CONSTRAINT hardhat_wallet_pool_profile_fkey 
...
CREATE INDEX IF NOT EXISTS idx_wallet_pool_assigned ON public.hardhat_wallet_pool(is_assigned);
CREATE INDEX IF NOT EXISTS idx_wallet_pool_profile ON public.hardhat_wallet_pool(assigned_to_profile_id);
